    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      {isLoading && (
        <div
          role="status"
          aria-live="polite"
          style={{ position: 'absolute', bottom: '10px', left: '10px', zIndex: 1000, background: 'white', padding: '6px 10px', borderRadius: '20px', boxShadow: '0 2px 6px rgba(0,0,0,0.15)', display: 'flex', alignItems: 'center', gap: '6px' }}
        >
      ...
      <div
        role="group"
        aria-label="Legend"
        style={{ position: 'absolute', bottom: '10px', right: '10px', zIndex: 1000, background: 'white', padding: '8px', borderRadius: '6px', boxShadow: '0 2px 6px rgba(0,0,0,0.15)', fontSize: '11px' }}
      >
